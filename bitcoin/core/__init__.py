...
class LitecoinMainParams(CoreChainParams):
    MAX_MONEY = 4 * 21000000 * COIN
    NAME = 'litecoin'

class LitecoinTestNetParams(CoreChainParams):
    MAX_MONEY = 4 * 21000000 * COIN
    NAME = 'litecoin'
...
def _SelectCoreParams(name):
    ...
    if name == 'mainnet':
        ...
        coreparams = LitecoinMainParams()
    elif name == 'litecoinTestnet':
        coreparams = LitecoinTestNetParams()
    else:
